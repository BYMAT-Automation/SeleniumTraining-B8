...
public class TestBase { // Heart of the Framework
	...
	public void initialization() throws IOException {
		...
		excel = new ExcelReader(System.getProperty("user.dir")+"\\src\\test\\resources\\testData\\MasterSheet_B8.xlsx");
	
		String timestamp = new SimpleDateFormat("YYYY_MM_dd_HH_mm_SS").format(new Date());
		report = new ExtentReports(System.getProperty("user.dir")+"\\src\\test\\resources\\executionReports\\ExtentReportResult_"+timestamp+".html");
	...
	public void closingBrowser() throws InterruptedException  {
		...
		test.log(LogStatus.INFO, "Test case "+testCaseName+" execution has been completed and Browser has been closed");
	}
